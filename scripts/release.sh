...
echo "  1. Monitor the release: https://github.com/dlt-hub/dlt-mcp/actions/workflows/release.yaml"
echo "  2. Draft the release notes: https://github.com/dlt-hub/dlt-mcp/releases/new?tag=$NEW_VERSION"
